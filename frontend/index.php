...
<body>
    ...
    <main>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="../assets/uploads/slider/slider3.webp" class="d-block w-100" alt="Slide 3" style="height: 500px; object-fit: cover;">
                    <div class="container">
...
<div class="col-md-7">
                ...
                <div class="col-md-5">
                    <img src="../assets/uploads/slider/R.jpg" class="d-block w-100" alt="Slide 1" style="height: 500px; object-fit: cover;">
</div>
            </div>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 order-md-1">
                    <img src="../assets/uploads/slider/339.jpg" class="d-block w-100" alt="Slide 1" style="height: 500px; object-fit: cover;">
                </div>
            </div>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <img src="../assets/uploads/slider/111.jpg" class="d-block w-100" alt="Slide 1" style="height: 500px; object-fit: cover;">
                </div>
            </div>
  ...
  <div class="card shadow-sm">
    <a href="pages/details.php?id=<?= $item[0] ?>">
      <img src="../assets/shared/img/<?= $item[4] ?>" alt="<?= $item[1] ?>" class="img-fluid" style="height: 225px; object-fit: cover;">
    </a>
    <div class="card-body">
      <p class="card-text">
      ...
      <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="pages/details.php?id=<?= $item[0] ?>" class="btn btn-sm btn-outline-secondary">Add cart</a>
      </div>
    </div>
  </div>
</div>
